                ...
                try{
                    ...
                    try{
                        ...
                        while (clientSearch.next()){
                            ...
                            Tables t=new Tables();
                            clientSearchTable=t.clientSearchTable(clientSearchTableModel);
                            clientSearchTable.setBounds(0,0,ScreenSize.scr_width*40/100,ScreenSize.scr_height);
                            J2C3Operation.emptyPanel.removeAll();

                            J2C3Operation.emptyPanel.add(clientSearchTable);
                            J2C3Operation.emptyPanel.setVisible(false);
                            J2C3Operation.emptyPanel.setVisible(true);
